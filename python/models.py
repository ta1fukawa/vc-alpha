...
class EmbedModel1d(torch.nn.Module):
    def __init__(self, sp_length):
        ...
        self.conv1a = torch.nn.Conv1d(sp_length, 512, kernel_size=5, stride=1, dilation=1, padding='same')
        self.conv1b = torch.nn.Conv1d(512, 512, kernel_size=5, stride=1, dilation=1, padding='same')
        ...
        self.conv4a = torch.nn.Conv1d(512, 512, kernel_size=1, stride=1, dilation=1, padding='same')
        self.conv4b = torch.nn.Conv1d(512, 512, kernel_size=1, stride=1, dilation=1, padding='same')
        self.drop4  = torch.nn.Dropout(p=0.2)
        self.conv5  = torch.nn.Conv1d(512, 1500, kernel_size=1, stride=1, dilation=1, padding='same')
        self.drop5  = torch.nn.Dropout(p=0.2)
        self.line1  = torch.nn.Linear(3000, 512)
