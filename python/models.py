...
class EmbedModel1d(torch.nn.Module):
    def __init__(self, model_type, n_freq, n_frames):
        ...
        if self.model_type == 'stats_pooling':
            ...
            self.conv5  = torch.nn.Conv1d(512, 512, kernel_size=3, dilation=1, padding='same')
            self.line5  = torch.nn.Linear(1024 * n_frames, 512)
...
class EmbedModel2d(torch.nn.Module):
    def __init__(self, model_type, n_freq, n_frames, pool_size=(2, 4)):
        ...
        self.conv1a = torch.nn.Conv2d(1, 16, kernel_size=(3, 3), dilation=(1, 1), padding='same')
        self.conv1b = torch.nn.Conv2d(16, 16, kernel_size=(3, 3), dilation=(1, 1), padding='same')
        self.drop1  = torch.nn.Dropout2d(p=0.2)
        self.pool1  = torch.nn.MaxPool2d(kernel_size=pool_size)
        
        self.conv2a = torch.nn.Conv2d(16, 64, kernel_size=(3, 3), dilation=(1, 1), padding='same')
        ...
        self.conv3a = torch.nn.Conv2d(64, 256, kernel_size=(3, 3), dilation=(1, 1), padding='same')
        ...
        self.conv4a = torch.nn.Conv2d(256, 1024, kernel_size=(3, 3), dilation=(1, 1), padding='same')
        self.conv4b = torch.nn.Conv2d(1024, 1024, kernel_size=(3, 3), dilation=(1, 1), padding='same')
        self.drop4  = torch.nn.Dropout2d(p=0.2)
        self.pool4  = torch.nn.MaxPool2d(kernel_size=pool_size)
        
        # self.conv5a = torch.nn.Conv2d(1024, 2048, kernel_size=(3, 3), dilation=(1, 1), padding='same')
        # self.conv5b = torch.nn.Conv2d(2048, 2048, kernel_size=(3, 3), dilation=(1, 1), padding='same')
        # self.drop5  = torch.nn.Dropout2d(p=0.2)
        # self.pool5  = torch.nn.MaxPool2d(kernel_size=pool_size)
        
        # self.conv6a = torch.nn.Conv2d(2048, 8192, kernel_size=(3, 3), dilation=(1, 1), padding='same')
        # self.conv6b = torch.nn.Conv2d(8192, 8192, kernel_size=(3, 3), dilation=(1, 1), padding='same')
        # self.drop6  = torch.nn.Dropout2d(p=0.2)
        # self.pool6  = torch.nn.MaxPool2d(kernel_size=pool_size)
        
        if self.model_type == 'stats_pooling':
            self.conv7  = torch.nn.Conv2d(1024, 2048, kernel_size=(3, 3), dilation=(1, 1), padding='same')
